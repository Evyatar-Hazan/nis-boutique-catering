...
export const boutiqueReasons: readonly SimpleCard[] = [
  {
    title: 'תפריט שנבנה לפי הצורך שלכם',
    text: 'כל הזמנה מתחילה בשיחה קצרה על סוג האירוח, מספר הסועדים והתחושה שרוצים ליצור, ואז מתורגמת לכיוון מדויק יותר.',
    icon: ClipboardList,
  },
  {
    title: 'הגשה ואריזה שנראות טוב מהרגע הראשון',
    text: 'לא רק אוכל טעים, אלא שולחן שנפתח יפה, מגשים שמרגישים מוכנים לאורחים ואריזה שממשיכה את השפה של המותג.',
    icon: Sparkles,
  },
  {
    title: 'יחס אישי ולא תעשייתי',
    text: 'אתם לא נכנסים למסלול גנרי. יש שיחה, תיאום ותשומת לב לפרטים כדי שהפתרון יתאים לאירוח הספציפי שלכם.',
    icon: HeartHandshake,
  },
  {
    title: 'פרטים קטנים שמרגישים בוטיק',
    text: 'מגשים, מארזים, קפה, סידור והגשה שמחזיקים יחד את הטעם, הנראות והחוויה השלמה.',
    icon: Package,
  },
];
...
export const processSteps: readonly SimpleCard[] = [
  {
    ...
    text: 'מספרים בקצרה מה סוג האירוח, מה התאריך ומה הכיוון הכללי שחשבתם עליו.',
    icon: MessageCircle,
  },
  {
    title: 'מחדדים סוג אירוח וכמות',
    text: 'מבינים יחד אם מדובר בשבת, אירוע קטן או מארזים, כמה סועדים יש ומה חשוב לכם שירגיש על השולחן.',
    icon: CalendarDays,
  },
  {
    title: 'מקבלים הצעה או תפריט מותאם',
    text: 'בונים כיוון של תפריט, הגשה ופרטים קטנים שמחברים בין הטעם, הנראות והאירוח שלכם.',
    icon: ClipboardList,
  },
  {
    title: 'סוגרים פרטים ומקבלים מוכן להגשה',
    text: 'מסכמים תאריך, אופן קבלה והתאמות, ואז מקבלים אוכל מסודר, אסתטי ונוח להגשה בלי להסתבך.',
    icon: CheckCircle2,
  },
];
...
export const faqs: readonly Readonly<{ question: string; answer: string }>[] = [
  ...
  },
  {
    ...
    answer: 'כן. מעלים את הרגישויות, האלרגיות או ההעדפות כבר בתחילת השיחה, ובודקים יחד מה אפשר להתאים בפועל להזמנה.',
  },
  {
