/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c277c5b1b020ab297d4ae0a8ce9f9627)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	GOOGLE_CLIENT_ID: "1071746882514-thn0l2mpo0t3dgrcanfb14sjmr4gpof7.apps.googleusercontent.com";
	GITHUB_REPOSITORY_OWNER: "Evyatar-Hazan";
	GITHUB_REPOSITORY_NAME: "nis-boutique-catering";
	GITHUB_WORKFLOW_FILE: "cloudflare-pages.yml";
	VITE_GOOGLE_CLIENT_ID: string;
	VITE_GOOGLE_API_KEY: string;
	VITE_GOOGLE_SHEET_ID: string;
	VITE_GOOGLE_DRIVE_FOLDER_ID: string;
	VITE_GOOGLE_APPS_SCRIPT_PUBLISH_URL: string;
	VITE_ALLOWED_EDITORS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GITHUB_REPOSITORY_OWNER" | "GITHUB_REPOSITORY_NAME" | "GITHUB_WORKFLOW_FILE" | "VITE_GOOGLE_CLIENT_ID" | "VITE_GOOGLE_API_KEY" | "VITE_GOOGLE_SHEET_ID" | "VITE_GOOGLE_DRIVE_FOLDER_ID" | "VITE_GOOGLE_APPS_SCRIPT_PUBLISH_URL" | "VITE_ALLOWED_EDITORS">> {}
}
