...
type AdminTab = 'admins' | 'sections' | 'services' | 'gallery' | 'contact' | 'publish';
...
const tabs: readonly TabDefinition[] = [
  {
    id: 'admins',
    label: 'ניהול אדמינים',
    help: 'הרשאות כניסה והוספת מנהלים',
    icon: <ShieldCheck aria-hidden="true" />,
  },
  {
    id: 'sections',
    label: 'אזורי תוכן',
    help: 'כותרות, טקסטים וסדר הופעה',
    icon: <FileText aria-hidden="true" />,
  },
  {
    id: 'services',
    label: 'חוויות אירוח',
    help: 'שירותים וכרטיסי מכירה',
    icon: <Sparkles aria-hidden="true" />,
  },
  {
    id: 'gallery',
    label: 'גלריה',
    help: 'תמונות, קטגוריות והעלאה ל־Drive',
    icon: <Images aria-hidden="true" />,
  },
  {
    id: 'contact',
    label: 'יצירת קשר ו־SEO',
    help: 'טלפון, וואטסאפ ושיתוף קישורים',
    icon: <Phone aria-hidden="true" />,
  },
  {
    id: 'publish',
    label: 'פרסום',
    help: 'שמירה, בנייה ובדיקת אתר חי',
